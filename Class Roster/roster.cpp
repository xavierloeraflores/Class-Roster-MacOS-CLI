...
Roster::Roster(string studentData[]){
    for(int i = 0; i < 5; i++){
        ...
        string studentID = studentString.substr(leftPos, rightPos);
        //Parse firstName
        leftPos = rightPos;
        rightPos = studentString.find(',', leftPos);
        difference = rightPos - leftPos;
        string firstName = studentString.substr(leftPos, rightPos);
        
        //Parse lastName
        leftPos = rightPos;
        rightPos = studentString.find(',', leftPos);
        difference = rightPos - leftPos;
        string lastName = studentString.substr(leftPos, rightPos);
        
        //Parse email
        leftPos = rightPos;
        rightPos = studentString.find(',', leftPos);
        difference = rightPos - leftPos;
        string email = studentString.substr(leftPos, rightPos);
        
        //Parse age
        leftPos = rightPos;
        rightPos = studentString.find(',', leftPos);
        difference = rightPos - leftPos;
        int age = stoi(studentString.substr(leftPos, rightPos));
        
        //Parse daysInCourse1
        leftPos = rightPos;
        rightPos = studentString.find(',', leftPos);
        difference = rightPos - leftPos;
        int daysInCourse1 = stoi(studentString.substr(leftPos, rightPos));
        
        //Parse daysInCourse2
        leftPos = rightPos;
        rightPos = studentString.find(',', leftPos);
        difference = rightPos - leftPos;
        int daysInCourse2 = stoi(studentString.substr(leftPos, rightPos));
        
        //Parse daysInCourse3
        leftPos = rightPos;
        rightPos = studentString.find(',', leftPos);
        difference = rightPos - leftPos;
        int daysInCourse3 = stoi(studentString.substr(leftPos, rightPos));
        
        //Parse degreeProgram
        leftPos = rightPos;
        rightPos = studentString.find(',', leftPos);
        difference = rightPos - leftPos;
        string degreeProgramString = studentString.substr(leftPos, rightPos);
